...
#the coefficients for Boomers and Millennials do show striking similarities, with 
#the exception of race stuff. So the fact that a black person model looks so similar
#between the two generations is perhaps a bit odd. 
