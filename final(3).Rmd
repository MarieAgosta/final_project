...
#We renamed the levels pertaining to education, and then coded them as factors. It goes form 1-5 and 5 is the highest (graduate edu)
...
#We renamed th elabels pertainin to race and removed all missing data 
...
#To save space, we created a smaller data set from our original data set, it includes all relevant variables, which are listed below the code. 
...
# We named the variables so they are very easy to undertand 
...
#set up an objects that allow for proper id and weights to be used in the data sets
