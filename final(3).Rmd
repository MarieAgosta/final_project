...
#With Labels 
ci.plot(simZ_boomer_black, ylim = 0:1, ylab = "Probability of voting",axis(side = 1, at = 1:5, tick = TRUE, 
...
ci.plot(simZ_genY_white, ylim = 0:1, ylab = "Probability of voting",
        main = "White Male Millenial with HS Edu")
...
ci.plot(simZ_boomer_white, ylim = 0:1, ylab = "Probability of voting",
        main = "White Male Babyboomer with HS Edu")
