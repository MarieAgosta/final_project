...
setZ_genY <- setx(Z_genY, education = 1:5)
...
setZ_boomer <- setx(Z_genY, education = 1:5)
...
colnames(blackfem_ed_genY) <- c("lb", "probability", "ub")
colnames(blackfem_ed_boomer) <- c("lb", "probability", "ub")
